...
namespace E_Shop.Controllers
{
    ...
    public class AdminCategoryController : Controller
    {
        ...
        [ValidateAntiForgeryToken] /* Textlere değer girişi yaparak eklemek lazım. Onun kontrolü */
        [HttpPost]
        ...
        public ActionResult Update(Category p)
        {
            if (ModelState.IsValid)
            {
                ...
                update.Name = p.Name;   /*Nesne başvurusunun örneği alınmadı hatası veriyor*/
